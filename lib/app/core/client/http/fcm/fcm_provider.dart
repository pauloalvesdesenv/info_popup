...
class FCMProvider {
  ...
  static Future<void> postSend(String userId, Map<String, dynamic> body) async {
    try {
      await Dio().post('https://fcm.googleapis.com/v1/projects/aco-plus-fa455/messages:send',
          options: Options(headers: {'Authorization': 'Bearer ${await _getAccessToken()}', 'Content-Type': 'application/json'}), data: body);
      await FirestoreClient.notificacoes.add(NotificacaoModel.fromFCMMap(userId, body));
    } catch (_) {
      return;
    }
  }
  ...
  static Future<String> _getAccessToken() async {
    final serviceAccountJson = {
      ...
      "client_email": "firebase-adminsdk-ojuxq@aco-plus-fa455.iam.gserviceaccount.com",
      "client_id": "104857910631039811272",
      "auth_uri": "https://accounts.google.com/o/oauth2/auth",
      "token_uri": "https://oauth2.googleapis.com/token",
      "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
      "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-ojuxq%40aco-plus-fa455.iam.gserviceaccount.com",
