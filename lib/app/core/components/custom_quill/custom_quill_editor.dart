...
class _CustomQuillEditorState extends State<CustomQuillEditor> {
  ...
  void _onTapOverLaySuggestionItem(String value, {required String? uid}) {
    var lastHashTagIndexPrivate = lastHashTagIndex;
    _controller.replaceText(
        lastHashTagIndexPrivate!,
        _controller.selection.extentOffset - lastHashTagIndexPrivate,
        value,
        null);
    _controller.updateSelection(
        TextSelection(
            baseOffset: lastHashTagIndexPrivate - 1,
